...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="Discover the lastest trends for food lovers">
...
<body>
  ...
  <header class="container-fluid" id="menu">
    <nav id="toogle-menu">
      ...
      <button class="open-button" onclick="openForm()"><img src="img/admin1.png" alt"admin icon" class="admin-icon" aria-label="admin connexion"></button>
      <label id="icone">
